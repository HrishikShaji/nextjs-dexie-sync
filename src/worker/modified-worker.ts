...
async function updateMessageSyncStatus({
  ...
  try {
    console.log("@@SYNCING MESSAGE", messageId, status, conversationId)
    ...
    console.log("@@ERROR SYNCING MESSAGE", messageId, status, conversationId)
  }
...
async function onConversationSync(data: any) {
  try {
    ...
    console.log("@@ERROR SYNCING CONVERSATION", data)
  }
}
